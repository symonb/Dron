...
{ [TASK_SYSTEM] = DEFINE_TASK("SYSTEM CHECK", task_system_fun, NULL, TASK_PRIORITY_LOW, TASK_PERIOD_HZ(FREQUENCY_SYSTEM_CHECK)),
 [TASK_IBUS_SAVE] = DEFINE_TASK("RX SAVING", rx_save_fun, rx_save_check_fun, TASK_PRIORITY_REALTIME, TASK_PERIOD_HZ(FREQUENCY_RX_READING)),
 ...
 [TASK_ACC_UPDATE] = DEFINE_TASK("ACC READ&FILTER", acc_update, acc_update_check_fun, TASK_PRIORITY_MEDIUM, TASK_PERIOD_HZ(FREQUENCY_STABILIZATION_LOOP)),
 ...
 [TASK_STABILIZATION_LOOP] = DEFINE_TASK("STABILIZATION LOOP", stabilization_fun, stabilization_check_fun, TASK_PRIORITY_MEDIUM, TASK_PERIOD_HZ(FREQUENCY_STABILIZATION_LOOP)),
