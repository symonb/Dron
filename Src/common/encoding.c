...
/**
 *@brief Maps all values of a signed integer into those of an unsigned integer.
 * @param value signed integer
 * @retval unsigned integer after conversion
 * @note ZigZag encoding maps all values of a signed integer into those of an unsigned integer in such
